...
public class SectionChecker extends ParameterSaver {
    ...
    public void durabilityForSteel(int shapeCase) {
        ...
        double strRatio = resistances.getStretchingResistance() * 1.3 / 0.87 / 1.05;
        double compRatio = resistances.getCompressiveResistance() * 1.3 * 0.58 / 1.05;
    ...
    public void durabilityForWood(int shapeCase) {
        ...
        double StrMoment = getStretchingMoment();
        double StrForce = getStretchingForce();
        double strRatio = resistances.getStretchingResistance() * 0.53 * 1 * 1 * 1 / 1.2;
        double compRatio = resistances.getCompressiveResistance() * 0.53 * 1 * 1 * 1 / 1.2;
    ...
    public void durabilityForConcrete(int shapeCase) {
        ...
        double StrMoment = getStretchingMoment();
        double StrForce = getStretchingForce();
        double strRatio = resistances.getStretchingResistance() / 1.3;
        double compRatio = resistances.getCompressiveResistance() * 0.9 / 1.3;
