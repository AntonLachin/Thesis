    ...
    public boolean shapeParametersToDouble() {
        ...
        try {
            if ((!height.isDisable() && (Double.parseDouble(height.getText())) <= 0.0) || (!width.isDisable() && Double.parseDouble(width.getText()) <= 0.0) ||
                ...
                informationText.setVisible(true);
                informationText.setText("Параметры сечения должны быть больше 0!");
                return false;
            ...
            try {
                if ((fixedSupportFive.isSelected() || hardTerminationFive.isSelected()) && consoleOrNot.isSelected()) {
                    ...
                    threads.add(new Callable() {
                        @Override
                        public Object call() {
                            calculator.calculateMomentsNoMomentNoConsole(calculator.getAccuracy(), calculator.getA1(), calculator.getC1(), calculator.getL1(),
                                    calculator.getM1(), calculator.getQ1(), calculator.getN1(), calculator.getBindingMomentsFirst());
                            calculator.calculateMomentsNoMomentNoConsole(calculator.getAccuracy(), calculator.getA2(), calculator.getC2(), calculator.getL2(),
                                    calculator.getM2(), calculator.getQ2(), calculator.getN2(), calculator.getBindingMomentsSecond());
                            return null;
                        }
                    });
                    threads.add(new Callable() {
                        @Override
                        public Object call() {
                            calculator.calculateMomentsNoMomentNoConsole(calculator.getAccuracy(), calculator.getA3(), calculator.getC3(), calculator.getL3(),
                                    calculator.getM3(), calculator.getQ3(), calculator.getN3(), calculator.getBindingMomentsThird());
                            calculator.calculateMomentsNoMomentNoConsole(calculator.getAccuracy(), calculator.getA4(), calculator.getC4(), calculator.getL4(),
                                    calculator.getM4(), calculator.getQ4(), calculator.getN4(), calculator.getBindingMomentsFourth());
                            return null;
                        }
                    });
